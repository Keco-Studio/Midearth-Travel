...
export const homeModuleSeeds: HomeModuleRecord[] = [
  ...
  createModule(
    ...
    [
      ...
      { key: "mailtoRecipient", label: "Mail recipient", type: "text", required: true },
      {
        ...
        type: "text",
        maxLength: 30,
        helper: "Synced with Global Settings and Footer.",
      },
      {
        key: "primaryPhoneHref",
        label: "Primary phone link",
        type: "link",
        maxLength: 80,
      ...
      {
        key: "secondaryPhoneHref",
        label: "Secondary phone link",
        type: "link",
        maxLength: 80,
        helper: "Synced with Global Settings (tel:...).",
      },
  ...
  createModule(
    "footer",
    10,
    "Manage footer copy, contact phones, and link columns.",
    "published",
    [
      ...
      { key: "copyrightText", label: "Copyright text", type: "text", required: true, maxLength: 120 },
      {
        ...
        type: "text",
        maxLength: 30,
        helper: "Synced with Global Settings and Quote Request.",
      },
      {
        key: "primaryPhoneHref",
        label: "Primary phone link",
