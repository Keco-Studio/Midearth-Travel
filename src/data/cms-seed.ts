...
export const homeModuleSeeds: HomeModuleRecord[] = [
  createModule(
    "navbar",
    1,
    "Manage logo images, alt text, navigation labels, and phones. Book Now dials Global Settings → Primary phone href; other nav targets are fixed in code.",
    "published",
    [
      ...
      { key: "bookNowLabel", label: "Book now label", type: "text", required: true, maxLength: 20 },
      {
        ...
        maxLength: 30,
        helper:
          "Shown in the header. Synced with Global Settings, Quote Request, Footer, and Final CTA. Book Now uses the tel: link from Global Settings.",
      },
      {
