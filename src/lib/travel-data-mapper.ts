...
export function mapTravelToursToRecords(): TourRecord[] {
  return tours.map((tour) => {
    const record = {
      ...
      busTourPackage: tour.busTourPackage ?? tour.tourType === "Bus Tour",
      destinationCategoryIds: [] as string[],
    ...
    return {
      ...record,
      destinationCategoryIds: resolveTourDestinationCategoryIds({
        ...record,
        destinationCategoryIds: tour.destinationCategoryIds,
      }),
    };
  });
}
